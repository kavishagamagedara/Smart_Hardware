...
import { Bell, MessageCircle, RotateCcw, Star, Trash2 } from "lucide-react";
...
export default function NotificationsPanel({ scope = "user" }) {
  ...
  const loadNotifications = useCallback(async () => {
    ...
    setError("");
    try {
      const res = await fetch(`${API_ROOT}/api/notifications?limit=100`, {
        headers,
      });
